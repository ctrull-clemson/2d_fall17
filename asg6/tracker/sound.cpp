  ...
  channels()
{
  ...
  music = Mix_LoadMUS(Gamedata::getInstance().getXmlStr("game/music"));
  ...
  sounds.push_back( Mix_LoadWAV("sound/Bump.wav") ); // Player/terrain collision
  sounds.push_back( Mix_LoadWAV("sound/Bark.wav") ); // Dog barking sound
  sounds.push_back( Mix_LoadWAV("sound/Door.wav") ); // Door closes when dog returned
  sounds.push_back( Mix_LoadWAV("sound/Chew.wav") ); // Dog when contact with treat
  sounds.push_back( Mix_LoadWAV("sound/GameWon.wav") ); // Victory noise
